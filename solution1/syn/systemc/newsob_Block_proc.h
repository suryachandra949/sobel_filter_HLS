...
#ifndef _newsob_Block_proc_HH_
#define _newsob_Block_proc_HH_
...
struct newsob_Block_proc : public sc_module {
    ...
    // Module declarations
    newsob_Block_proc(sc_module_name name);
    SC_HAS_PROCESS(newsob_Block_proc);
